...
public class PostRepositoryTest {
    ...
    public void testSave() {
        ...
        //-> save 메세드는 테이블에 삽입할 엔터티를 파라미터에 전달하면,
        //   테이블에 저장된(save) 엔터티 객체를 리턴.
    ...
    public void update() {
        ...
        //save() 메서드의 아규먼트가 DB에 없는 엔터티면 insert, DB에 있는 엔터티이면 update
        postRepository.saveAndFlush(entity);
    }
    
    @Test
    public void testDelete() {
       long count = postRepository.count(); //DB테이블의 행의 개수(엔터티 개수)
